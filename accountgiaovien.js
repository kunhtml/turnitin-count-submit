...
// @version      1.0
// @description  Đếm số ô submit cụ thể và 24h sinh viên có thể submit bao nhiêu lần
...
(function() {
    ...
    function displayCounts(specificCount, paperCount) {
        ...
        infoDiv.innerHTML = `
            ...
            <p>Tổng số submit 24h sinh viên có thể submit: <span style="color: #ff4d4f;">${total}</span></p>
        `;
